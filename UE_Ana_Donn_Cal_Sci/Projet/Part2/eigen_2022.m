function [W, V, flag] = eigen_2022(imat, n, v, m, eps, maxit, percentage, p, genere)
...
% percentage, pbaseourcentage de la trace que l'on veut atteindre (v1, v2, v3)
...
switch v
    ...
    case 1
      ...
      case 2
        ...
        % appel à la version 2+3 de la subspace iteration method
