...
p_pensees = 1/3;
p_oeillets =1/3;
p_chrysanthemes = 1-p_pensees-p_oeillets;

code_classe = zeros(size(V_pensees));
max_V_chrysanthemes = (max(max(V_pensees.*p_pensees,V_oeillets.*p_oeillets),V_chrysanthemes.*p_chrysanthemes)==V_chrysanthemes);
max_V_oeillets = (max(max(V_pensees.*p_pensees,V_oeillets.*p_oeillets),V_chrysanthemes.*p_chrysanthemes)==V_oeillets);
max_V_pensees = (max(max(V_pensees.*p_pensees,V_oeillets.*p_oeillets),V_chrysanthemes.*p_chrysanthemes)==V_pensees);
