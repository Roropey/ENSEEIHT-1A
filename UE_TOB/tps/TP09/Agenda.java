public interface Agenda {
	 ...
	 */
	void enregistrer(int creneau, String rdv) throws OccupeException, IllegalArgumentException;
	 ...
	 */
	String getRendezVous(int creneau) throws LibreException, IllegalArgumentException;
