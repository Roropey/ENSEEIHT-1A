...
public class ExempleSchema2 {
	...
	public static void main(String[] args)
	{
		...
		Point p1 = new PointNomme(3, 2,"A"); //p1 est un PointNomme
		Point p2 = new PointNomme(6, 9,"S"); //p2 est un PointNomme
		...
		Point barycentre = new PointNomme(sx / 3, sy / 3, "C"); //barycentre est un PointNomme
