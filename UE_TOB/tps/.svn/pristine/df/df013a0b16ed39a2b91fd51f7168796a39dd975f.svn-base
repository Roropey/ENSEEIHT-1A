...
public class ExempleSchemaList {
	...
	public static void main(String[] args)
	{
		...
		//Objet_Geometrique schema[] = new Objet_Geometrique[10];	// le schéma
			// 10 : capacité suffisante ici, non contrôlée dans la suite.
		int nb = 0;		// Le nombre d'éléments dans le schéma
		ArrayList<Objet_Geometrique> schema =  new ArrayList<Objet_Geometrique>();
