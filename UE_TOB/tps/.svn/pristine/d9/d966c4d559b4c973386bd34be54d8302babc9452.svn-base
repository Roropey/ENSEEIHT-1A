...
public class Menu implements Commande {
	...
	public Menu(String sonTitre, Commande affichage) {
	...
	public boolean estExecutable() {
		...
		for (int i = 1; i <= this.getNbEntrees(); i++) {
			executable = executable || this.getEntree(i).getCommande().estExecutable();
		}
		return executable;
	}
