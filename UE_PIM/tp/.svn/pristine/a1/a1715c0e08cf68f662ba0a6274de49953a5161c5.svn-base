...
private
   ...
   -- Stocker dans l'ordre croissant des indices permet de faciliter le rapprochement de 2 vecteurs, indice à indice
   -- Sinon, il faudrait parcourir à chaque fois le vecteur pour trouver l'élément à l'indice correspondant.
		end record;
