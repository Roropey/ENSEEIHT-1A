...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_liste_chainee" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b2088a02#;
   pragma Export (C, u00001, "test_liste_chaineeB");
   ...
   u00121 : constant Version_32 := 16#5e1ca842#;
   pragma Export (C, u00121, "liste_chaineeB");
   u00122 : constant Version_32 := 16#9db4127e#;
   pragma Export (C, u00122, "liste_chaineeS");
