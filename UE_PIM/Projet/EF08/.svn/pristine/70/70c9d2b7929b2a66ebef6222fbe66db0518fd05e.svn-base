...
package Flux_Binaire is
    ...
    -- Obtenir le bit d'indice Indice de Octet.
    ...
    function L_Octet (Flux : in T_Flux_Binaire;
                      Indice : in Integer) return T_Octet;
    ...
    procedure Ajouter_Octet (Flux : in out T_Flux_Binaire; Octet : in T_Octet);
 	...
 	-- Ajouter les bits di flux Flux_deux au flux Flux
    procedure Ajouter_Flux (Flux : in out T_Flux_Binaire;
                            Flux_deux : in T_Flux_Binaire);
    ...
    generic
        with procedure Traiter (Octet : in T_Octet);
    procedure Pour_Chaque (Flux : in T_Flux_Binaire);
