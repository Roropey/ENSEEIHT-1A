...
package body Interface_utilisateur is
    ...
    begin
        ...
        if Argument_Count > 2 then
            ...
            -- savoir s'il y a l'option bavard
    ...
    begin
        case Octet is
            when 10 =>
                Caractere := To_Unbounded_String ("'\n'");
            when others =>
                Caractere := To_Unbounded_String (Character'Val (Octet)'Image);
        end case;
    ...
    procedure Afficher_Arbre (Arbre : in T_Arbre;
                              ...
                              Afficher_Frequence : in Boolean) is
    ...
    begin
        if Arbre = null then
            ...
            if Arbre.Gauche = null then
                if Arbre.Cle = 0 then
                    Texte_affiche := Texte_affiche & ' ' & To_Unbounded_String ("'\$'");
                else
